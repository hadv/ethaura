...
contract VerifyWebAuthnSigTest is Test {
    ...
    function test_VerifySignatureComponents() public view {
        ...
        assertEq(
            clientDataHash,
            0x37baba0da8fb389dd03b1dda7fb23dc38b730e5f3c3df56388dc72e8f22cbe7b,
            "ClientDataHash mismatch"
        );
        assertEq(
            messageHash, 0xd7cec55e322302be89b6c8052974f5266287ba60cebabdf3ce48ee31788e3a5f, "MessageHash mismatch"
        );
    }
}
